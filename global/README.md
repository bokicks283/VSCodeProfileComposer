...
cSpell uses custom decorations so spelling issues stay out of VS Code's Problems panel. Its correction menu is displayed inline, while the shared Main keybindings provide `Ctrl+Shift+S` for direct spelling suggestions.
